...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: <FiGithub />, url: 'https://github.com/khrisdain' },
    { name: 'LinkedIn', icon: <FiLinkedin />, url: 'https://www.linkedin.com/in/mideilesanmi/' },
    { name: 'Email', icon: <FiMail />, url: 'mailto:samuelilesanmi15@gmail.com' },
  ];
