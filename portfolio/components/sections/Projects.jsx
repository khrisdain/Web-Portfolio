...
const projectsData = [
  ...
  },
  {
    ...
    description: 'An interactive portfolio website featuring Three.js animations and effects.',
  ...
  },
  {
    ...
    description: 'A mobile-responsive fitness tracking application with progress visualization and workout plans.',
  ...
  return (
    ...
    >
      ...
      <div className="aspect-video w-full overflow-hidden rounded-t-xl bg-secondary-700 mb-6 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-secondary-500 bg-gradient-to-br from-secondary-600 to-secondary-900">
